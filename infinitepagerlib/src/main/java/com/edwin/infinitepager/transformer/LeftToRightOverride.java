 ...
 * @author 陈学玉
 */
public class LeftToRightOverride extends AbsTransformer {

    public LeftToRightOverride() {
        super();
    }

    public LeftToRightOverride(int duration) {
        super(duration);
    }
    ...
    @Override
    public Animator doForwardAnimation(final InfinitePager pager, View current,
